...
<HTML lang="en-us">
    ...
    <title>The Portrait Maker-Order Details</title>
...
<h2><p>ORDER DETAILS</P></h2>
<p>Customers Order [Portrait sketch/Painting]</P>
</section>
<div class="detai">
...
<td><?php echo $row['complete_on'];?></td>
<td>
...
<?php }else{ ?>
    <p class="status error">ALL ORDER'S HAS BEEN COMPLETED...</p> 
<?php } ?>
